...
The shared page template includes Vercel Web Analytics through Vercel's HTML
tracking script; Web Analytics must also be enabled for the project in the Vercel
dashboard.
